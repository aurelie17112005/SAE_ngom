...
-- Inserts pour la table coupe_jean
...
-- Inserts pour la table taille
;

-- Inserts pour la table etat
...
-- Inserts pour la table ligne_panier
...
-- Inserts pour la table ligne_commande
...
-- Inserts pour la table jean (15 inserts aléatoires)
-- Correction des inserts pour la table jean (15 inserts aléatoires avec champ image)
